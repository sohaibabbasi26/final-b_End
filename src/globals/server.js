...
module.exports = async function FastServer(options) {
    ...
    const registerRoutes = async ({ routes, prefix }) => {
        ...
        // _server.register(require('@fastify/swagger'), swaggerDocument.options)
        ...
        // _server.register(require('@fastify/swagger'), swaggerDocument.options)
        _server.register(require('@fastify/swagger'), swaggerDocument.options)
        _server.register(require('@fastify/swagger-ui'), swaggerDocument.options)



        _server.get("/kuchbhi", (req, res) => {
            res.send("mehdiiii")
        })


        _server.get("/", (req, res) => { res.send("Hii Server") })
